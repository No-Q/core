...
public class TileSystem
{
    ...
    public static Coordinate LatLongToPixelXY(double latitude, double longitude, int levelOfDetail)
    {
        latitude = Clip(latitude, MinLatitude, MaxLatitude);
        ...
        Coordinate coor = new Coordinate((int) Clip(x * mapSize + 0.5, 0, mapSize - 1), (int) Clip(y * mapSize + 0.5, 0, mapSize - 1));
        return coor;
    }
    ...
    public static Coordinate PixelXYToTileXY(int pixelX, int pixelY)
    {
    	Integer tileX = pixelX / 256;
        Integer tileY = pixelY / 256;
        Coordinate coor = new Coordinate(tileX, tileY);
        return coor; 
    }
    ...
    public static void TileXYToPixelXY(int tileX, int tileY, Integer pixelX, Integer pixelY)
    {
        pixelX = tileX * 256;
        pixelY = tileY * 256;
    }
    ...
    public static void QuadKeyToTileXY(String quadKey, Integer tileX, Integer tileY, Integer levelOfDetail) throws Exception
    {
        tileX = tileY = 0;
